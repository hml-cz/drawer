...
function DrawerPopup(props, ref) {
  ...
  // =========================== Swipe ============================
  var bind = (0, _react2.useDrag)(function (_ref3) {
    var down = _ref3.down,
      _ref3$swipe = (0, _slicedToArray2.default)(_ref3.swipe, 1),
      swipeX = _ref3$swipe[0],
      cancel = _ref3.cancel;
    if (placement === 'left' && swipeX === 1 || placement === 'right' && swipeX === -1) {
      // cancel swipe to right if Drawer has left placement,
      // and cancel left swipe for right Drawer
      cancel();
    } else {
      if (swipeX !== 0 && down === false) {
        // close Drawer if swipe is detected and finished
        var _event = new CustomEvent('touchSwipeEvent');
        onClose(_event);
      }
    }
  }, {
  ...
  var panelNode = /*#__PURE__*/React.createElement(_rcMotion.default, (0, _extends2.default)({
  ...
  }), function (_ref4, motionRef) {
    var _contentWrapperRef$cu;
    var motionClassName = _ref4.className,
      motionStyle = _ref4.style;
    return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({
      ...
      placement: placement,
      drawerWidth: (contentWrapperRef === null || contentWrapperRef === void 0 || (_contentWrapperRef$cu = contentWrapperRef.current) === null || _contentWrapperRef$cu === void 0 ? void 0 : _contentWrapperRef$cu.clientWidth) || 0,
      onClose: onClose
    }, (0, _pickAttrs.default)(props, {
      aria: true
  ...
  }, bind()), maskNode, /*#__PURE__*/React.createElement("div", {
    tabIndex: 0,
